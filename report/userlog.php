...
<div class="card-body">
	<div>
		<div style="padding-bottom: 5px; padding-top: 5px; display: table-row;">	   
		  ...
		  <button class="btn bg-primary " onclick="location.href='./?report=userlog&session=<?= $session; ?>';" title="Reload all data"></i> <?= $_all ?></button>
		</div>
		<div class="input-group mr-b-10">  
            ...
            <div class="input-group-2 col-box-3">	
				<div style="padding:3.5px;"  class="group-item group-item-r text-center pointer" onclick="filterR();"><i style="margin-right: 10px;" class="fa fa-search"></i> Filter</div>
			</div>
